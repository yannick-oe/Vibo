...
- **Emoji artwork:** [Twemoji](https://github.com/jdecked/twemoji) (jdecked fork), licensed [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) — the full set self-hosted as SVG (generated by `scripts/generate-emoji.mjs`).
- **Emoji metadata** (German names, keywords, categories): [emojibase](https://github.com/milesj/emojibase) (`emojibase-data`, de locale), licensed [MIT](https://opensource.org/licenses/MIT).
