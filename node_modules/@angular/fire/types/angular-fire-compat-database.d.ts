...
import * as _angular_fire_compat_database from '@angular/fire/compat/database';
...
interface AngularFireList<T> {
    ...
    valueChanges<K extends string>(events?: ChildEvent[], options?: {
        idField: K;
    }): Observable<(T & Partial<Record<K, string>>)[]>;
...
declare function stateChanges<T>(query: DatabaseQuery, events?: ChildEvent[], scheduler?: SchedulerLike): rxjs.Observable<_angular_fire_compat_database.AngularFireAction<_angular_fire_compat_database.DatabaseSnapshot<T>>>;
