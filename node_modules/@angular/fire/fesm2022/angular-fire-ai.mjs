...
import { getAI as getAI$1, getGenerativeModel as getGenerativeModel$1, getImagenModel as getImagenModel$1, getLiveGenerativeModel as getLiveGenerativeModel$1, startAudioConversation as startAudioConversation$1 } from 'firebase/ai';
...
class AIModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: AIModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.0", ngImport: i0, type: AIModule });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: AIModule, providers: [
            DEFAULT_AI_INSTANCE_PROVIDER,
            AI_INSTANCES_PROVIDER,
        ] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: AIModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        DEFAULT_AI_INSTANCE_PROVIDER,
...
const getLiveGenerativeModel = _zoneWrap(getLiveGenerativeModel$1, true);
const startAudioConversation = _zoneWrap(startAudioConversation$1, true);

/**
 * Generated bundle index. Do not edit.
 */

export { AI, AIInstance$, AIInstances, AIModule, getAI, getGenerativeModel, getImagenModel, getLiveGenerativeModel, provideAI, startAudioConversation };
