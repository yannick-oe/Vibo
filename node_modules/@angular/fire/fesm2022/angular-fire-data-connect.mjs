...
class DataConnectModule {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: DataConnectModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.0.0", ngImport: i0, type: DataConnectModule });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: DataConnectModule, providers: [
            DEFAULT_DATA_CONNECT_INSTANCE_PROVIDER,
            DATA_CONNECT_INSTANCES_PROVIDER,
        ] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.0.0", ngImport: i0, type: DataConnectModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        DEFAULT_DATA_CONNECT_INSTANCE_PROVIDER,
